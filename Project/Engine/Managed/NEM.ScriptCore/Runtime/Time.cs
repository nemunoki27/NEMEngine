...
public static class Time {
    ...
    public static float UnscaledFixedDeltaTime => NativeApplicationAPI.ReadUnscaledFixedDeltaTime();

    // Play 開始からの経過秒数（scaled / unscaled）
    public static double TimeSinceStartup => NativeApplicationAPI.ReadTimeSinceStartup();
    public static double UnscaledTime => NativeApplicationAPI.ReadUnscaledTime();
    ...
    public static ulong FrameCount => NativeApplicationAPI.ReadFrameCount();
}
