...
public sealed partial class ParticleSystem {
    ...
    public void Play(bool withChildren = true) =>
        NativeRenderingAPI.ParticleSystemControlCall(entity.native, PlayOperation,
    ...
    public void PlayOneShot(bool withChildren = true) =>
        NativeRenderingAPI.ParticleSystemControlCall(entity.native, PlayOneShotOperation,
            ParticleSystemStopBehavior.StopEmitting, withChildren);

    // 現在位置を保持して更新を一時停止する
    public void Pause(bool withChildren = true) =>
        NativeRenderingAPI.ParticleSystemControlCall(entity.native, PauseOperation,
            ParticleSystemStopBehavior.StopEmitting, withChildren);
    ...
    public void Stop(bool withChildren = true,
        ...
        NativeRenderingAPI.ParticleSystemControlCall(entity.native, StopOperation,
            stopBehavior, withChildren);

    // 再生状態を変えずに既存粒子をすべて消す
    public void Clear(bool withChildren = true) =>
        NativeRenderingAPI.ParticleSystemControlCall(entity.native, ClearOperation,
            ParticleSystemStopBehavior.StopEmitting, withChildren);

    public bool isPlaying =>
        NativeRenderingAPI.ParticleSystemStateCall(entity.native, PlayingState) != 0;
    public bool isEmitting =>
        NativeRenderingAPI.ParticleSystemStateCall(entity.native, EmittingState) != 0;
    public bool isPaused =>
        NativeRenderingAPI.ParticleSystemStateCall(entity.native, PausedState) != 0;
    public bool isStopped =>
        NativeRenderingAPI.ParticleSystemStateCall(entity.native, StoppedState) != 0;
    public int particleCount =>
        NativeRenderingAPI.ParticleSystemStateCall(entity.native, ParticleCountState);

    // 子階層を含めて生存粒子または再生中のSystemがあるか返す
    public bool IsAlive(bool withChildren = true) =>
        NativeRenderingAPI.ParticleSystemStateCall(
