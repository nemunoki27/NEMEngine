...
public static class Camera {
    ...
    public static bool TryWorldToScreenPoint(
        ...
        return NativeTransformAPI.ReadWorldToScreenPoint(worldPosition, out screenPosition);
    }
    ...
    public static bool TryWorldToScreenPoint(
        ...
        if (NativeTransformAPI.ReadWorldToScreenPoint(worldPosition, out Vector3 position)) {
    ...
    public static bool ScreenPointToRay(Vector2 screenPos, out Ray ray) {
        ...
        if (NativeTransformAPI.ReadScreenPointToRay(screenPos, out Vector3 origin, out Vector3 direction)) {
    ...
    public static bool TryGetMousePositionInView(out Vector2 position) {
        return NativeInputAPI.ReadMousePositionInView(out position);
    }
