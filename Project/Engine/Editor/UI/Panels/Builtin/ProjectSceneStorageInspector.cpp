...
//============================================================================
void Engine::ProjectSceneStorageInspector::DrawSceneStoragePopup(const EditorPanelContext& context, AssetDatabase& database) {
...
void Engine::ProjectSceneStorageInspector::ReportFailure(const std::string& message) {

	sceneStorageMessage_ = message;
	requestSceneStoragePopup_ = true;
}
