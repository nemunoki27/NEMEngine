#include "Rigidbody2DInspectorDrawer.h"
...
//============================================================================
//	Rigidbody2DInspectorDrawer classMethods
//============================================================================

void Engine::Rigidbody2DInspectorDrawer::DrawFields([[maybe_unused]] const EditorPanelContext& context,
	...
	//============================================================================
	{
		...
		DrawField(anyItemActive, [&]() {
			return MyGUI::DragVector2("初速度", draft.linearVelocity,
				{ .dragSpeed = 0.01f });
			});
	}
	...
	//============================================================================
	{
		...
		DrawField(anyItemActive, [&]() {
			return InspectorDrawerCommon::DrawCheckboxField("回転を固定", draft.freezeRotation);
			});
		DrawField(anyItemActive, [&]() {
